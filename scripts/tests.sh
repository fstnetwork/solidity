...
function download_aleth()
{
    if [[ "$OSTYPE" == "darwin"* ]]; then
        ...
        ALETH_HASH="7b47b122639f2314c11e08f04d9ad4efc2c8e511"
        wget -q -O /tmp/test/aleth.tar.gz https://github.com/ethereum/aleth/releases/download/v1.4.0rc6/aleth-1.4.0rc6-linux-x86_64.tar.gz
